let limite = prompt('Entre 1 y que numero le gustaria adivinar:');
let maximosIntentos = prompt('Cuantos intentos desea jugar:');
...
while (numeroUsuario != numeroSecreto) {
    numeroUsuario = parseInt(prompt(`Ingrese un numero entre 1 y ${limite}: `));
